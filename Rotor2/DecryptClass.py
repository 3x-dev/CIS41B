# class Decrypter:
#     def decrypt_character(self, encrypted_char, rotor1, rotor2, position_index):
...
#     def decrypt_text(self, encrypted_text, rotor1, rotor2):
#         decrypted_text = ""
#         for i, char in enumerate(encrypted_text):
#             decrypted_text += self.decrypt_character(char, rotor1, rotor2, i)
#             rotor1.rotate()
